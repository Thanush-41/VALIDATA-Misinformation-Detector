...
import { BsSun, BsMoon, BsDroplet, BsStar } from 'react-icons/bs';
...
function Header(props) {
    ...
    const { theme } = context.state;
    const { toggleTheme } = context;

    const getThemeIcon = () => {
        switch(theme) {
            case 'light': return <BsMoon size={20} />;
            case 'dark': return <BsDroplet size={20} />;
            case 'blue': return <BsStar size={20} />;
            case 'purple': return <BsSun size={20} />;
            default: return <BsMoon size={20} />;
        }
    };
                    ...
                    <Container>
                        <LinkContainer to='/'>
                            <Navbar.Brand href="/">
                                ...
                                <span className='brand-text-primary'>VALIDATA</span> <span className='brand-text-accent'>News Guardian</span>
                            </Navbar.Brand>
                        </LinkContainer>
                        ...
                        <Navbar.Collapse id="hearder-navbar" className="justify-content-end">
                            ...
                            <Nav>
                                <LinkContainer to='/documentation'>
                                    <Nav.Link className={activeContainer === 4 ? 'active-link' : 'inactive-link'}>
                                        <div>
                                            <li>
